...
import aki.aika.purrfriends.databinding.ActivityPurrFirstPageBinding
...
class WelcomeActivity : AppCompatActivity() {
    private lateinit var binding: ActivityPurrFirstPageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPurrFirstPageBinding.inflate(layoutInflater)
